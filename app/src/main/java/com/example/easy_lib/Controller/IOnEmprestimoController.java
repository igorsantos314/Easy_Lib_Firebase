...
public interface IOnEmprestimoController {
    void insertEmprestimo (String dataEmprestimo, String dataDevolucao, String status, String cpfCliente, String nomeCliente, ArrayList<ItemEmprestimo> itens_emprestimo);
    void updateEmprestimo (String uid, String dataEmprestimo, String dataDevolucao, String status, String cpfCliente, String nomeCliente, ArrayList<ItemEmprestimo> itens_emprestimo);
